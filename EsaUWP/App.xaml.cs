    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                ...
                titleBar.BackgroundColor = Windows.UI.Color.FromArgb(0xff, 0x0a, 0x9b, 0x94);

                //非アクティブ時のタイトルバーの文字色、背景色の指定
                titleBar.InactiveForegroundColor = Windows.UI.Colors.White;
                titleBar.InactiveBackgroundColor = Windows.UI.Color.FromArgb(0xff, 0x0a, 0x9b, 0x94);

                //タイトルバーに付随の最大・最小化ボタン、閉じるボタンの文字色、背景色の指定
                titleBar.ButtonForegroundColor = Windows.UI.Colors.White;
                titleBar.ButtonBackgroundColor = Windows.UI.Color.FromArgb(0xff, 0x0a, 0x9b, 0x94);
